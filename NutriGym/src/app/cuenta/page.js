...
export default function AccountPage() {
  ...
  useEffect (() => {
    setTitle("Cuenta");
    setName("description");
    setContent("Inicia sesión o registrate.");
  }, []);
      ...
      <div className="relative w-full h-64 bg-white">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <div className="space-x-4">
            <Link href="/cuenta/inicio-de-sesion">
            <button className="bg-gray-800 text-white px-6 py-2 rounded hover:bg-gray-700 transition-colors">
              INICIAR SESIÓN
            </button>
            </Link>
            <Link href="/cuenta/registro">
            <button className="bg-white text-gray-800 px-6 py-2 rounded border border-gray-800 hover:bg-gray-100 transition-colors">
              CREAR CUENTA
            </button>
            </Link>
          </div>
